                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="http://bigit.io/images/logo.png" alt="" height="19">
                                </span>
                            </a>
                            ...
                            <div class="col-xl-9">
                                    ...
                                    <div class="col-md-7">
                                        <div class="btn-toolbar" role="toolbar">
                                            <div class="btn-group mr-2 mb-3">
                                                <a href="inbox.php"><button type="button" class="btn btn-primary waves-light waves-effect"><i class="fas fa-arrow-left "></i></button></a>
                                            </div>
                                ...
                                <div class="card mb-0">
                                    <div class="card-body">
                                            ...
                                            <div class="btn-group ml-md-2 mb-3">
                                                <?php
                                                    if($row_request['status'] != 'sent')
                                                    {
                                                        ...
                                                        $status = "<span class='badge-danger badge mr-3'>Request for ".$amount."</span>";
                                                    }
                                                    else
                                                    {
                                                        $amount = $row_request['amount'];
                                                        $status = "<span class='badge-success badge mr-3'>You already sent ".$amount."</span>";
                                                    }
                                                    echo $status;
                                                ?>
                                        ...
                                        <p>Dear <?php echo $row_customer['full_name'];?>,</p>
